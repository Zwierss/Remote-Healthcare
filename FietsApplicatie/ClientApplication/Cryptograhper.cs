...
public static class Cryptograhper
{
    
    /* This is the key used to encrypt and decrypt the message. */
    ...
    /* This is the initialization vector used to encrypt and decrypt the message. */
    ...
    /// </summary>
    /// <param name="JObject">The JObject is a JSON object that is created from the JSON string that is sent from the
    /// client.</param>
    /// <returns>
